...
health_potion = Item("Health Potion", "!", (127, 0, 255), consumable=HealingConsumable(4))
lightning_scroll = Item("Lighting Scroll", "~", (255, 255, 0), consumable=LightningDamageConsumable(20, 5))
confusion_scroll = Item("Confusion Scroll", "~", (207, 63, 255), consumable=ConfusionConsumable(10))
fireball_scroll = Item("Fireball Scroll", "~", (255, 0, 0), consumable=FireballDamageConsumable(3, 12))
